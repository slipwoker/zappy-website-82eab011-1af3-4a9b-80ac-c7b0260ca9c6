...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function handleFormSubmit(e) {
    ...
    const honeypot = form.querySelector('input[name="website"], input[name="honeypot"]');
    ...
    if (!isValid) {
      ...
      if (errorSummary) {
        errorSummary.textContent = 'Please correct the highlighted fields.';
        errorSummary.style.display = 'block';
      }
      const firstInvalid = form.querySelector('.error, .invalid');
      if (firstInvalid) {
        firstInvalid.focus();
      }
      return;
  ...
  function checkScrollAnimations() {
    ...
    animatedElements.forEach(element => {
      ...
      if (elementTop < triggerPoint && rect.bottom > 0) {
        element.classList.add('visible', 'animated', 'fade-in-visible');
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '82eab011-1af3-4a9b-80ac-c7b0260ca9c6',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '82eab011-1af3-4a9b-80ac-c7b0260ca9c6';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '82eab011-1af3-4a9b-80ac-c7b0260ca9c6';
